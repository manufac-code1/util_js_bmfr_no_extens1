...
const { BundleAnalyzerPlugin } = require("webpack-bundle-analyzer"); // Analyzes the bundle and generates a stats file
...
module.exports = {
  ...
  plugins: [
    ...
    new BundleAnalyzerPlugin({
      analyzerMode: "disabled", // Disable the analyzer's browser-based report
      generateStatsFile: true, // Generate a stats.json file
      statsOptions: { source: false }, // Options for stats file generation
    }),
  ],
  devServer: {
    static: {
